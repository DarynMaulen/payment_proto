...
const (
	...
	PaymentService_Deposit_FullMethodName           = "/payment.v1.PaymentService/Deposit"
	PaymentService_Withdrawal_FullMethodName        = "/payment.v1.PaymentService/Withdrawal"
...
func (c *paymentServiceClient) Withdrawal(ctx context.Context, in *WithdrawalRequest, opts ...grpc.CallOption) (*WithdrawalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPaymentServiceServer) Withdrawal(context.Context, *WithdrawalRequest) (*WithdrawalResponse, error) {
...
func _PaymentService_Withdrawal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Withdrawal(ctx, req.(*WithdrawalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
