...
func (x *DepositRequest) GetReceiverId() string {
	if x != nil {
		return x.ReceiverId
	}
	return ""
...
func (x *DepositResponse) GetPayment() *PaymentProto {
	if x != nil {
		return x.Payment
	}
	return nil
...
func (x *WithdrawalRequest) GetSenderId() string {
	if x != nil {
		return x.SenderId
	}
	return ""
...
func (x *WithdrawalRequest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *WithdrawalResponse) GetPayment() *PaymentProto {
	if x != nil {
		return x.Payment
	}
	return nil
...
const file_payment_proto_rawDesc = "" +
	...
	"\apayment\x18\x01 \x01(\v2\x18.payment.v1.PaymentProtoR\apayment\"\x86\x01\n" +
	"\x11WithdrawalRequest\x12\x1b\n" +
	"\tsender_id\x18\x01 \x01(\tR\bsenderId\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x03R\x06amount\x12\x1a\n" +
	"\bcurrency\x18\x03 \x01(\tR\bcurrency\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\"H\n" +
	"\x12WithdrawalResponse\x122\n" +
	"\apayment\x18\x01 \x01(\v2\x18.payment.v1.PaymentProtoR\apayment\"\xe3\x02\n" +
	...
	"\n" +
	"updated_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xed\x03\n" +
	"\x0ePaymentService\x12E\n" +
	"\bTransfer\x12\x1b.payment.v1.TransferRequest\x1a\x1c.payment.v1.TransferResponse\x12B\n" +
	"\aDeposit\x12\x1a.payment.v1.DepositRequest\x1a\x1b.payment.v1.DepositResponse\x12K\n" +
	"\n" +
	"Withdrawal\x12\x1d.payment.v1.WithdrawalRequest\x1a\x1e.payment.v1.WithdrawalResponse\x12K\n" +
	"\n" +
...
var file_payment_proto_goTypes = []any{
	...
	(*DepositRequest)(nil),            // 8: payment.v1.DepositRequest
	(*DepositResponse)(nil),           // 9: payment.v1.DepositResponse
	(*WithdrawalRequest)(nil),         // 10: payment.v1.WithdrawalRequest
	(*WithdrawalResponse)(nil),        // 11: payment.v1.WithdrawalResponse
	(*PaymentProto)(nil),              // 12: payment.v1.PaymentProto
	(*timestamppb.Timestamp)(nil),     // 13: google.protobuf.Timestamp
}
var file_payment_proto_depIdxs = []int32{
	12, // 0: payment.v1.TransferResponse.payment:type_name -> payment.v1.PaymentProto
	12, // 1: payment.v1.GetPaymentResponse.payment:type_name -> payment.v1.PaymentProto
	12, // 2: payment.v1.GetPaymentHistoryResponse.payments:type_name -> payment.v1.PaymentProto
	12, // 3: payment.v1.DepositResponse.payment:type_name -> payment.v1.PaymentProto
	12, // 4: payment.v1.WithdrawalResponse.payment:type_name -> payment.v1.PaymentProto
	13, // 5: payment.v1.PaymentProto.created_at:type_name -> google.protobuf.Timestamp
	13, // 6: payment.v1.PaymentProto.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 7: payment.v1.PaymentService.Transfer:input_type -> payment.v1.TransferRequest
	8,  // 8: payment.v1.PaymentService.Deposit:input_type -> payment.v1.DepositRequest
	10, // 9: payment.v1.PaymentService.Withdrawal:input_type -> payment.v1.WithdrawalRequest
	2,  // 10: payment.v1.PaymentService.GetPayment:input_type -> payment.v1.GetPaymentRequest
	4,  // 11: payment.v1.PaymentService.GetPaymentHistory:input_type -> payment.v1.GetPaymentHistoryRequest
	6,  // 12: payment.v1.PaymentService.CancelPayment:input_type -> payment.v1.CancelPaymentRequest
	1,  // 13: payment.v1.PaymentService.Transfer:output_type -> payment.v1.TransferResponse
	9,  // 14: payment.v1.PaymentService.Deposit:output_type -> payment.v1.DepositResponse
	11, // 15: payment.v1.PaymentService.Withdrawal:output_type -> payment.v1.WithdrawalResponse
	3,  // 16: payment.v1.PaymentService.GetPayment:output_type -> payment.v1.GetPaymentResponse
	5,  // 17: payment.v1.PaymentService.GetPaymentHistory:output_type -> payment.v1.GetPaymentHistoryResponse
	7,  // 18: payment.v1.PaymentService.CancelPayment:output_type -> payment.v1.CancelPaymentResponse
